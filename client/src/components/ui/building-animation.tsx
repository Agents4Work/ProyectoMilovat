...
export const BuildingAnimation: React.FC = () => {
  return (
    <div className="relative w-full h-full flex justify-end items-center bg-black overflow-hidden">
      <svg width="600" height="600" viewBox="0 0 800 600" fill="none" className="mr-0">
